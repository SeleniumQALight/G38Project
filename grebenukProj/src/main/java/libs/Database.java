...
public class Database {
   ...
   static Logger log = Logger.getLogger(Database.class);
    ...
    public List selectTable(String query) throws SQLException {
        ...
        List<ArrayList> resultTable=new ArrayList<ArrayList>(); // select colums from table
     ...
     * @throws SQLException
     */
    public int changeTable(String query) throws SQLException { // int - skolko zapisey izmenilos
    ...
    public String randDbValue(String query) throws SQLException {
        ...
        stm.close();
        value=value.trim(); // to cut not useful spaces from data
        return value;
    }
